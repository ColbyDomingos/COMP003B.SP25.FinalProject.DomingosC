...
namespace COMP003B.SP25.FinalProject.DomingosC.Controllers
{
    public class ServiceTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,EstimatedTime,Price")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,EstimatedTime,Price")] ServiceType serviceType)
        {

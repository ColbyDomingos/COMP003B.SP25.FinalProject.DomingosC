namespace COMP003B.SP25.FinalProject.DomingosC.Models
{
    public class Booking
    {
        ...
        public string Status { get; set; } = string.Empty; //how the status of the car is, finished, working etc
        ...
        public ICollection<BookingMechanic> BookingMechanics { get; set; } = new List<BookingMechanic>();//Connects with the booking mechanic code structure
    }
}

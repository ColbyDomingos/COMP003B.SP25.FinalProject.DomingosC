...
namespace COMP003B.SP25.FinalProject.DomingosC.Models
{
    public class ServiceType
    {
        ...
        public string Name { get; set; } = string.Empty;//the name of the servicetype
        public string Description { get; set; } = string.Empty;//description of what needs to be done

...
namespace COMP003B.SP25.FinalProject.DomingosC.Models
{
    public class Vehicle
    {
        ...
        [Required]
        public string Make { get; set; } //requires the make of the car

        [Required]
        public string Model { get; set; } // requires a model for the car
        ...
        public string LicensePlate { get; set; } // the liscense plate for the vehicle
